...
System.register("./__entry.js", ['./__monkey.entry-CV88MDl6.js'], (function (exports, module) {
	'use strict';
	return {
		setters: [null],
		execute: (function () {
...
System.register("./__monkey.entry-CV88MDl6.js", ['@soniox/speech-to-text-web'], (function (exports, module) {
  'use strict';
  var SonioxClient;
  return {
    setters: [module => {
...
`;
      ...
      function trimSeen(now) {
        while (seen$1.length > 0 && now - seen$1[0].ts > WINDOW_MS) seen$1.shift();
      }
      async function uploadSnapshot() {
        ...
        const now = Date.now();
        trimSeen(now);
        const uniqueUsers = new Set(seen$1.map((item) => item.uid).filter(Boolean));
      ...
      function startLiveDeskSync() {
        ...
        unsubscribe$1 = subscribeCustomChatEvents((event) => {
          if (event.kind !== "danmaku") return;
          const now = Date.now();
          seen$1.push({ ts: now, uid: event.uid });
          trimSeen(now);
        });
        timer = setInterval(() => {
          void uploadSnapshot();
      ...
      async function pickByLLM(roomId, source) {
        ...
        try {
          const { chooseMemeWithLLM } = await __vitePreload(async () => {
            const { chooseMemeWithLLM: chooseMemeWithLLM2 } = await module.import('./llm-driver-SlAVl2Lc-BhZdlY14.js');
        ...
        const handleTestLLM = async () => {
          ...
          try {
            const { testLLMConnection } = await __vitePreload(async () => {
              const { testLLMConnection: testLLMConnection2 } = await module.import('./llm-driver-SlAVl2Lc-BhZdlY14.js');
...
System.register("./llm-driver-SlAVl2Lc-BhZdlY14.js", ['./__monkey.entry-CV88MDl6.js', '@soniox/speech-to-text-web'], (function (exports, module) {
  'use strict';
